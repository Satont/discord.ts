...
export class PermissionGuards {
     ...
     */
    @Slash("permission_ban_members")
    @Guard(PermissionGuard(["BAN_MEMBERS"], "You do not have the role `BAN_MEMBERS`"))
     ...
     */
    @Slash("permission_ban_members")
    @Guard(PermissionGuard(PermissionGuards.resolvePermission, "You do not have the role `BAN_MEMBERS`"))
