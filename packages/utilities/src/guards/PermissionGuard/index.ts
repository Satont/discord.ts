 ...
 */
export function PermissionGuard(permissions: PermissionString[] | (() => Promise<PermissionString[]>), messageIfNotAllowed = "No permissions"): GuardFunction<CommandInteraction | SimpleCommandMessage | ContextMenuInteraction> {
    ...
    return async function (arg: CommandInteraction | SimpleCommandMessage | ContextMenuInteraction, client: Client, next: Next) {
        ...
        const perms = typeof permissions === "function" ? await permissions() : permissions;
